...
public interface IGenericsService<T extends IGenericsDTO<ID>, A extends IGenericsDTO<ID>, F extends IGenericsDTO<ID>, E extends IGenericsEntity<ID>, ID> {
    ...
    ResponseEntity<A> atualizarParcialOuLancarExcecao(ID id, A dto);
